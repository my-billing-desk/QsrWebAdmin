    ...
    return (
        <div className="flex flex-col h-full bg-main-app p-6 font-sans gap-6 overflow-y-auto">
            ...
            <div>
                ...
                <div className="text-sm text-muted">Pages / <span>Timeline</span></div>
            </div>

            {/* Timeline Container */}
            <div className="bg-surface rounded-xl shadow-sm border p-8" style={{ borderColor: 'var(--border-color)' }}>
                    ...
                    <div className="space-y-12">
                        {timelineData.map((item, idx) => (
                            <div key={idx} className="relative flex flex-col md:flex-row gap-8 items-start">
                                ...
                                {/* Mobile Date */}
                                <div className="md:hidden pl-12 text-sm text-muted mb-[-20px]">{item.date}</div>

                                {/* Node */}
                                <div className="absolute left-[8px] md:left-[140px] -translate-x-1/2 mt-1.5 w-4 h-4 rounded-full border-[3px] border-surface bg-gray-200 z-10 box-content" style={{ borderColor: 'var(--bg-surface)' }}>
